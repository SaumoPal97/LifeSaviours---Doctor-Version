...
public class MenuContent {
    ...
    static {
        ...
        addItem(new MenuItem("1", "Kshitiz Goel", ZoomingAndScrollingFragment.class));
        addItem(new MenuItem("2", "Gopabandhu Hota", ZoomingAndScrollingFragment.class));
        addItem(new MenuItem("3", "Abhilash Nandy", ZoomingAndScrollingFragment.class));
